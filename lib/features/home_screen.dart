...
import 'package:tb2_flutterproject/model/student.dart';
import 'package:tb2_flutterproject/utils/update_student_dialog.dart';
import 'package:tb2_flutterproject/utils/create_student_dialog.dart';
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          showDialog(
                            context: context,
                            builder: (context) => UpdateStudentDialog(student: student),
                          );
                        },
                      ),
                      SizedBox(width: 0),
